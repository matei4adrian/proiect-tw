              ...
              <div className=" border-0 rounded-lg shadow-lg relative flex flex-col read-more bg-white opacity-95 outline-none focus:outline-none">
                <div className="flex items-start justify-between p-5 border-b border-solid border-blueGray-200 rounded-t">
                  <div className="flex items-center">
                    <div className="py-1">
                      <svg
                        className="fill-red-600 h-6 w-6 text-teal-500 mr-4"
                    ...
                    <h3 className="text-3xl text-red-600 font-semibold">
                      Are you sure?
                    </h3>
                  </div>
                  <button
                ...
                <div className="flex items-center justify-end p-6 border-t border-solid border-blueGray-200 rounded-b">
                  <button
                    className="text-black background-transparent font-bold uppercase px-6 py-2 text-lg outline-none focus:outline-none mr-1 mb-1 ease-linear transition-all duration-150"
                    type="button"
                    onClick={() => setShowModal(false)}
                  >
                    No
